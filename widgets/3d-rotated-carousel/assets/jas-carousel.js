...
;(function($){
    ...
    $.fn.jasCarousel = function (option) {
        ...
        let appendControl = function(){
            carousel.controls.prev =  $("<a href='javascript:void(0)' class='prev'>"+carousel.settings.prevText+"</a>");
            carousel.controls.next =  $("<a href='javascript:void(0)' class='next'>"+carousel.settings.nextText+"</a>");
            ...
            carousel.controls.navigationWrap.append(carousel.controls.prev).append(carousel.controls.next);
            carousel.controls.navigationWrap.insertAfter(el) // This code I have adeed
